      ...
      <PageBox>
        <Box sx={{ display: "flex", flexDirection: "column", gap: 1, mb: 3 }}>
          ...
          <Typography variant="body1" color="text.secondary">
            Access owner statements and age analyses.
          </Typography>
        </Box>
        ...
        <SectionCard>
          ...
          <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
            {`Generate owner ${selectedItem.toLowerCase()} reports for financial analysis.`}
          </Typography>
                ...
                <Card sx={{ p: 2, height: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
                  <Box>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      {`Owner ${item.toLowerCase()} for financial reporting.`}
                    </Typography>
                  </Box>
                  <Button
                    variant={selectedItem === item ? "contained" : "outlined"}
