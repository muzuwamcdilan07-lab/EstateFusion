      ...
      <PageBox>
        <Box sx={{ display: "flex", flexDirection: "column", gap: 1, mb: 3 }}>
          ...
          <Typography variant="body1" color="text.secondary">
            Access detailed general ledger transactions, statements, and financial analyses.
          </Typography>
        </Box>
        ...
        <SectionCard>
          ...
          <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
            {`View and generate ${selectedItem.toLowerCase()} reports for financial analysis and record-keeping.`}
          </Typography>
                ...
                <Card sx={{ p: 2, height: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
                  <Box>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      {`Generate and review ${item.toLowerCase()} for the general ledger.`}
                    </Typography>
                  </Box>
                  <Button
                    variant={selectedItem === item ? "contained" : "outlined"}
