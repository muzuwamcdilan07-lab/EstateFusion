...
const items = ["Type", "Area", "Unit", "Size"];
      ...
      <PageBox>
        <Box sx={{ display: "flex", flexDirection: "column", gap: 1, mb: 3 }}>
          ...
          <Typography variant="body1" color="text.secondary">
            Access rental property type, area, unit, and size analyses.
          </Typography>
        </Box>
        ...
        <SectionCard>
          ...
          <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
            {`Generate ${selectedItem.toLowerCase()} reports for rental portfolio.`}
          </Typography>
                ...
                <Card sx={{ p: 2, height: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
                  <Box>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      {`${item} analysis for rental properties.`}
                    </Typography>
                  </Box>
                  <Button
                    variant={selectedItem === item ? "contained" : "outlined"}
